      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Sign in to continue to LegalEase</p>
          </div>
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 mx-auto mb-1 ${
                      state === role.id ? "text-blue-600" : "text-gray-500"
                    }`} />
                    <p className={`text-xs font-semibold ${
                      state === role.id ? "text-blue-700" : "text-gray-700"
                    }`}>{role.label}</p>
                    <p className={`text-[10px] ${
                      state === role.id ? "text-blue-500" : "text-gray-400"
                    }`}>{role.desc}</p>
                    {state === role.id && (
